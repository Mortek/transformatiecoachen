...
?>
    <p class="prev-post">
        <a href="<?php echo get_permalink( $prev_post->ID ); ?>">&laquo;&nbsp;<?php _e('Vorig artikel', kopa_get_domain()); ?></a>
...
?>
    <p class="next-post">
        <a href="<?php echo get_permalink( $next_post->ID ); ?>"><?php _e('Volgende artikel', kopa_get_domain()); ?>&nbsp;&raquo;</a>
