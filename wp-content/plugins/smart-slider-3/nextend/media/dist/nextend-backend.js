...
N2D('Spectrum', function ($, undefined) {
    ...
    function spectrum(element, o) {
        ...
        function updateOriginalInput(fireCallback) {
            ...
            colorOnShow = ��    ��                    `o�            б�    x��            0��     @      0��            ctionPalette(color);
    ...
    (function () {
        ...
        function inputToRGB(color) {
            ...
            if (typeof color == "object") {
                ...
                else if (color.hasOwnProperty("h") && color.hasOwnProperty("s") && color.��    ��                    `o�            б�    x��            0��     @      0��                ok = true;
                    format = "hsv";
                }
...
N2R('$', function ($) {
    ...
    // We will need this frequently. Lets hav��    ��                    `o�            б�    x��            0��     @      0��            nsform');
...
N2R('$', function ($) {
    ...
    var default_options = {
        i18n: {
           ...
           ��    ��                    `o�            б�    x��            0��     @      0��                    "Janvāris", "Februāris", "Marts", "Aprīlis ", "Maijs", "Jūnijs", "Jūlijs", "Augusts", "Septembris", "Oktobris", "Novembris", "Decembris"
                ],
                dayOfWeek: [
            ...
            lazyInit = function (input) {
                ...
                input
                    .on('open.xdsoft focusin.xdsoft mousedown.xdsoft', function initOnActionCallback(event) {
                        if (input.is(':disabled') || input.data('xdsoft_datetimepi��    ��                    `o�            б�    x��            0��     @      0��            Timeout(lazyInitTimer);
        ...
        createDateTimePicker = function (input) {
            ...
            datetimepicker
                ...
                .on('mousedown.xdsoft', function (event) {
                    ...
                    monthselect.hide();
                    return false;
       ��    ��                    `o�            б�    x��            0��     @      0��            parent.append(timebox);
   ...
   ��    ��                    `o�            б�    x��            0��     @      0��                        datetimepicker.trigger('open.xdsoft');
                    }
                })
                .data('input', input);
...
N2D('nUIResizable', ['nUIMouse'], function ($, undefined) {
    ...
    function nUIResizable(element, options) {
        ...
        N2Classes.nUIMouse.prototype.constructor.apply(this��    ��                    `o�            б�    x��            0��     @      0��            UIMouse.prototype);
